const getComic = async id => {
    ...
    let $link = $('<a>', {href: `https://xkcd.com/${randomComicId}/`}).text(data.safe_title);
    let $title = $('<h4>').append($link);
    let $comicContainer = $('<div>', {class:'comic-container'}).append($title).append($comic);
